...
import './../models/order_model.dart'; // Đường dẫn tới model Order của bạn
...
class InvoiceService {
  Future<Uint8List> generateInvoicePdf(Order order) async {
    ...
    // Load font hỗ trợ tiếng Việt từ assets
    // Đảm bảo tên file font chính xác và đã khai báo trong pubspec.yaml
    final fontData = await rootBundle.load("assets/fonts/Roboto-Regular.ttf");
    final ttfRegular = pw.Font.ttf(fontData);
    final boldFontData =
        await rootBundle.load("assets/fonts/Roboto-Bold.ttf"); // Font đậm
